					...
					<div class="card">
						<div class="card-body">
							...
							<form class="form-control" id="dateFilterForm">
								<div class="row">
									<div class="col-sm-2">
										<input class="form-control" type="text" onfocus="(this.type='date')" name="startDate" id="startDate" value="" placeholder="Start date">
									</div>
									<div class="col-sm-2">
										<input class="form-control" type="text" onfocus="(this.type='date')" name="endDate" id="endDate" value="" placeholder="End date">
									</div>
									<div class="col-sm-1">
										<input class="form-control btn-primary" type="button" name="search" id="dateFilterFormBtn" value="Search">
									</div>
									<div class="col-sm-1">
										<input class="form-control btn-danger" type="button" name="search" id="resetBtn" value="Reset">
									</div>
									<div class="col-sm-6" style="text-align: right">
										<a href="javascript:void(0)" style="text-decoration: none;box-shadow: none;" id="exportCsv">
											<img src="<?=base_url()?>/assets/images/csv-2.png" style="width: 72px;">
										</a>
									</div>
								</div>
							</form>
		...
		var dataTable=$('#datatableActivity').DataTable({
			...
			"columns": [
				...
				},
				{
					"data": "id",
					"render": function (data, type, row, meta) {
						let htmlBasic='<a style="margin-right:5px" class="btn btn-outline-secondary btn-sm edit" title="User Details" href="javascript:void(0)" id="VieUserDetails" data-parentid="'+row.unique_id+'" data-account-id="'+data+'"><i class="fas fa-align-left"></i></a>' +
