			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title mb-4">Add More Commision Refferal level</h4>
								<p style="color:red;"><?php echo $this->session->flashdata('msg'); ?></p>
								<form class="form-control" action="<?php echo base_url()."IBManagementController/saveIbCommisionRefMore/"?>" method="post">
									<div class="row">
										
										<input type="hidden" name="plan_id" id="plan_id" value="<?php echo $this->uri->segment(5) ?>">
										
										<input type="hidden" name="group_id" id="group_id" value="<?php echo $this->uri->segment(4) ?>">
									</div>
