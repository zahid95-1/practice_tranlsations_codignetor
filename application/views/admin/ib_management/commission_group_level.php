						...
						<div class="card">
							<div class="card-body">
								<div style="display: flex;justify-content: space-between;">
									<h4 class="card-title mb-4">Commission Group Level Wise</h4>
									<a href="<?php echo base_url()."admin/ib-management/commission-group-level" ?>"><button type="button" class="btn btn-outline-secondary btn-sm edit  waves-effect waves-light " id="">
											Add Commission Group Level
										</button></a>
								</div>
										...
										$c = 0;
										 ...
										 ?>
											<tr>
												...
												<td>
														<a href="<?php echo base_url()."view-commission-group-level/". $getComGroup->group_id ."/". $getComGroup->plan_id?>">
