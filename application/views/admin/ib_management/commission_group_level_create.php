			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title mb-4">Add New Commision Group level</h4>
								<p style="color:red;"><?php echo $this->session->flashdata('msg'); ?></p>
								<form class="form-control" action="<?php echo base_url()."admin/ib-management/commission-group-level"?>" method="post">
									<div class="row">
										<div class="col-sm-6">
									...
									<div class="row">
										<div class="row mt-3 mb-5">
											<div class="col-md-8">
												<input type="number" name="level" placeholder="HOW MANY LEVEL" class="form-control input-lg levelGenerate" id="levelName-1">
											</div>
											<div class="col-md-4">
			...
			if (levelNumber===''){
				...
				for (var index=1;index<=levelNumber;index++){
					html+=`<div class="mainrow" id="maindivRow-`+index+`-`+packageTypeName+`">
								<div class="row">
									<div class="col-md-4">
									<input name="LevelSetting[`+index+`][level_name]" class="form-control margin-top-10 no-left-border" type="text"  value="" required placeholder="Level Name">
									</div>
									<div class="col-md-4">
