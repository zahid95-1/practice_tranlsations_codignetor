							...
							<div class="card-body">
								...
								<table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
									...
									<tr>
										...
										<th>Level</th>
										<th>Parent IB</th>
										<th>Share From Parent IB</th>
									</tr>
									</thead>
									<tbody>
										<?php
										$c = 0;
										 foreach($ComGroupMasterData as $ComGroupDatavalue){
											$c++;
										 ?>
											<tr>
												<td><?php echo $c; ?></td>
												<td><?php echo $ComGroupDatavalue->username ?></td>
												...
												<td><?php echo $ComGroupDatavalue->parent_ib ?></td>
												<td><?php echo $ComGroupDatavalue->value ?></td>
											</tr>
										<?php } ?>
