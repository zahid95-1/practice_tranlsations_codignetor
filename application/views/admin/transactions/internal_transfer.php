			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-sm-flex align-items-center justify-content-between">
						<h4 class="mb-sm-0"><?=$this->lang->line('user_internal_transfer')?></h4>
					...
					<div class="card">
						<div class="card-body row">
							<div class="col-md-6">
								...
								<form action="<?=base_url('admin/transaction/user-internal-transfer')?>" method="post" id="userInternalTransfer" enctype="multipart/form-data">
