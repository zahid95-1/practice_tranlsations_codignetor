				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<h4 class="card-title mb-4"><?=isset($dataItem) ? count($dataItem) : '0'?> <?=$this->lang->line('approved_deposit_listing')?></h4>
									...
									<tr>
										...
										<?php if (ConfigData['enable_deposit_withdraw_rate']): ?>
											...
											<td>
												<?php
												if ($item->account_type_status==2){
													echo $getRateSettings['symbol'].($getRateSettings['dep_with_rate']*$item->entered_amount);
												}elseif ($item->account_type_status==1){
													echo $getRateSettings['symbol'].($item->live_rate*$item->entered_amount);
												}else{
													echo '$'.$item->entered_amount;
												}
												?>
											</td>
										<?php endif; ?>
										...
										<td>
											...
											if ($item->payment_mode==1){
												...
												echo "<span style='color: #0a53be'>Internal Transfer</span>";
											}elseif ($item->payment_mode==5){
												echo "<span style='color: #0a53be'>Commission Transfer</span>";
										...
										<td>
												...
												<a class="btn btn-outline-secondary btn-sm edit" target="_blank" href="<?=base_url().$item->transaction_proof_attachment?>">
										...
										<td>
												...
												<?php elseif($item->status==3): ?>
													<span class="badge rounded-pill bg-gradient">Rejected</span>
												<?php endif; ?>
											</td>
										<td>
