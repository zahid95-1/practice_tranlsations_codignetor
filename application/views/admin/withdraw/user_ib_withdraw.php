			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-sm-flex align-items-center justify-content-between">
						<h4 class="mb-sm-0"><?=$this->lang->line('make_user_ib_withdraw')?></h4>
						<div class="page-title-right">
							<ol class="breadcrumb m-0">
								<li class="breadcrumb-item">
									<a href="javascript: void(0);"><?=$this->lang->line('home')?></a>
								</li>
								<li class="breadcrumb-item active"><?=$this->lang->line('make_user_ib_withdraw')?></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-12">
					<?php if (isset($_SESSION['success_withdraw'])): ?>
						<div class="alert alert-success alert-dismissible fade show" role="alert">
							...
							<button type="button"
									...
									aria-label="<?=$this->lang->line('close')?>"></button>
						</div>
					...
					<div class="card">
						<div class="card-body row">
							<div class="col-md-6">
								<form action="<?=base_url('admin/withdraw/user-ib-withdraw-create')?>"
									  method="post"
									  id="ibWithdrawForm"
									...
									<div class="col-sm-12 mb-3">
										<label class="col-form-label">
											<?=$this->lang->line('label_ib_user_name')?> <span class="error">*</span>
										</label>
										<select class="form-control select2"
												name="unique_id"
												id="selectedUser">
											<option value="">
												<?=$this->lang->line('select_ib_user_name')?>
											</option>
									...
									<div class="col-sm-12 mb-3">
										<label class="col-form-label">
											<?=$this->lang->line('label_payout_method')?> <span class="error">*</span>
										</label>
										<div class="d-flex">
									...
									<div class="col-sm-12 mb-3">
										<label class="col-form-label">
											<?=$this->lang->line('label_ib_account_id')?> <span class="error">*</span>
										</label>
										<select class="form-control select2"
												name="mt5_login_id"
												id="mt5_login_id"
												required>
											<option value="">
												<?=$this->lang->line('select_ib_account_id')?>
											</option>
										</select>
									...
									<div class="col-sm-12 mb-3">
										<label class="col-form-label">
											<?=$this->lang->line('label_amount_usd')?> <span class="error">*</span>
										</label>
										<input class="form-control"
											   type="number"
											   name="amount"
											   id="amountWithdraw"
											   placeholder="<?=$this->lang->line('placeholder_amount_usd')?>"
											   min="<?=$min_withdrawal->min_withdrawal?>"
											   required>
									...
									<div class="col-sm-12 mb-3">
										<label class="col-form-label">
											<?=$this->lang->line('label_note')?> <span class="error">*</span>
										</label>
										<textarea class="form-control"
												  name="meta_descriptions"
												  style="height:100px"
												  required
												  placeholder="<?=$this->lang->line('placeholder_note')?>"></textarea>
...
<script>
	...
	$(document).on('change', 'select#selectedUser', function() {
		...
		var url = "<?php echo base_url();?>get-ib-user-bank-account-details";
