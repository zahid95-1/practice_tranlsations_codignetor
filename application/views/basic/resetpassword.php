...
<head>
	...
	<meta charset="utf-8" />
	<title><?=$metaTitle?> | Reset Password</title>
							...
							<div class="col-lg-9">
								<div>
									...
									<div class="p-2">
										...
										<form method="post" autocomplete="off" action="<?php echo base_url(); ?>forgot-password">
											...
											<div class="mb-3 auth-form-group-custom mb-4">
												...
												<input type="text" class="form-control" id="username" placeholder="Enter your email or mobile no" name="username">
