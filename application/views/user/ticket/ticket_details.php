					...
					<div class="p-3 px-lg-4 user-chat-border">
						<div class="row">
							<div class="col-md-4 col-6">
								...
								<p class="text-muted text-truncate mb-0">Ticket Id: <?=$dataItem->ticket_id?></p>
							</div>
							...
							<div class="row">
								<div class="col">
									<div class="position-relative">
										<form class="" action="<?php echo base_url()."user/add-feedback"?>" method="post" id="createTicket" enctype="multipart/form-data">
