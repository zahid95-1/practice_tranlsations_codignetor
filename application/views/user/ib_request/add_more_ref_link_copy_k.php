				...
				for (var index=1;index<=levelNumber;index++){
					html+=`<div class="mainrow" id="maindivRow-`+index+`-`+packageTypeName+`">
								<div class="row">
									...
									<div class="col-md-4">
										<input name="level_share_value_`+index+`" class="form-control margin-top-10 no-left-border " type="number"  value=""  step = "0.1"  max="<?php echo $getUserIbCommissionGroup->value ?>"  required placeholder="Share value">
									</div>
									<div class="col-md-4">
