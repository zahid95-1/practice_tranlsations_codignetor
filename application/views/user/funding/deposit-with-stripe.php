			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                                <h4 class="mb-sm-0"><?= lang('deposit_with_stripe') ?></h4>
						<div class="page-title-right">
							<ol class="breadcrumb m-0">
                                                                <li class="breadcrumb-item"><a href="javascript: void(0);"><?= lang('home') ?></a></li>
                                                                <li class="breadcrumb-item active"><?= lang('with_stripe') ?></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="card-body row">
							...
							<div class="col-lg-6" style="margin-top: 38px;">
								<div class="card border border-danger">
									...
									<div class="card-body">
                                                                               <h5 class="card-title"><?= lang('deposit_fund_via_stripe') ?></h5>
                                                                               <h5 class="card-title"><?= lang('stripe_account_required') ?></h5>
                                                                               <h5 class="card-title"><?= lang('need_support_email') ?> <?=ConfigData['support_mail']?></h5><br/>
                                                                               <h5 class="my-10 text-danger"><?= lang('stripe_supported_country_note') ?></h5>
										<br/>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6">
								...
								<form class="" action="<?php echo base_url()."user/deposit/deposit-stripe"?>" method="post" id="depositWireTransfer" enctype="multipart/form-data" >
									<div class="col-sm-12">
