			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-sm-flex align-items-center justify-content-between">
						<h4 class="mb-sm-0">Ib Commission WithDraw Request</h4>
						<div class="page-title-right">
							<ol class="breadcrumb m-0">
								<li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
								<li class="breadcrumb-item active">Ib Commission WithDraw Request</li>
							</ol>
						</div>
					</div>
				</div>
					...
					<div class="card">
						<div class="card-body row">
							<div class="col-lg-6" style="margin-top: 38px;">
								<div class="card border border-danger">
									...
									<div class="card-body">
										...
										<ul>
											<li class="d-flex">Account ID : <h5 class="card-title" style="margin-left: 10px" id="accountId"><?php if ($dataItem['tradeAccount']){
												if ($dataItem['tradeAccount'][0]){
													echo $dataItem['tradeAccount'][0]->mt5_login_id;
												}
													}?></h5></li>
											<li class="d-flex">Available Balance : <h5 class="card-title" style="margin-left: 10px">$<span id="totalBalanceAmount"><?=$dataItem['comBalance']?></span></h5></li>
							...
							<div class="col-md-6">
								...
								<form class="" action="<?php echo base_url()."user/ib-com-withdraw"?>" method="post" id="depositWireTransfer" enctype="multipart/form-data" >
									...
									<div class="col-sm-12">
										<label for="example-text-input" class="col-sm-12 col-form-label">Account ID<span class="error">*</span></label>
										<div class="">
									...
									<input type="hidden" name="totalBalance" id="totalbalance" value="<?=$dataItem['comBalance']?>">
									<div class="d-grid mb-3 mt-5">
										...
										<?php elseif(!empty($kycAttachment) && $kyc_validations==1 && $kycVerificationsStatus==false): ?>
											<button class="btn btn-primary" type="button" id="kycVerifiedBtnVerified">Withdraw Now</button>
										<?php else: ?>
...
<script>
	...
	$(document).on('change', 'select#mt5_login_id', function() {
		...
		var url = "<?php echo base_url();?>user/withdraw/get-ib-account-balance";
