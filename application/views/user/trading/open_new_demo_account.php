...
<div class="main-content open-account-area" id="result">
	<div class="page-content">
		<div class="container-fluid">
			...
			<form class="" action="<?php echo base_url()."user/user-create-demo-live-account"?>" method="post" id="createGroupForm">
				<div class="row">
							...
							<label class="card">
								...
								<span class="plan-details">
								  ...
								  <?php if (ConfigData['prefix']=='IGM' || ConfigData['prefix']=='UFX' || ConfigData['prefix']=='TG'): ?>
									  <span class="card-text">Commission : <?=$item->commission?></span>
									  <span class="card-text">Swap : <?=($item->swap==1)?'Yes':'No'?></span>
								  <?php endif; ?>
										...
										<?php endif; ?>
                                                                        ...
                                                                        <div class="leverage-card">
                                                                               <p class="card-text"><?= lang('balance') ?> :</p>
										<select class="form-control leverage-field disable-sections" id="selectBalance" style="margin-left: 25px;">
				...
				<input name="balance" type="hidden" value="1000" id="balance">
				...
				<div class="submit-btn-block">
					<button type="submit" class="btn btn-primary waves-effect waves-light">
                                                <i class="ri-check-line align-middle me-2"></i> <?= lang('create_new_demo_account') ?>
					</button>
				</div>
			</form>
...
<script>
	$(document).on('click', '#createGroupCard', function () {
		...
		$(this).closest('div').find('#selectBalance').removeClass('disable-sections');
	...
	$(document).on('change', '#selectBalance', function () {
