				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<h4 class="card-title mb-4"><?= lang('my_mt5_account_list') ?></h4>
							<table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
								...
								<?php if (isset($dataItem) && $dataItem): foreach ($dataItem as $key=>$data):
									...
									<tr>
										...
										<td>
                                                                               <a class="btn btn-outline-secondary btn-sm edit" href="<?=base_url()?>user/deposit"><?= lang('deposit') ?></a>
											</a>
										</td>
										<td>
                                                                               <a class="btn btn-outline-secondary btn-sm edit" href="<?=base_url()?>user/withdraw"><?= lang('withdraw') ?></a>
											</a>
