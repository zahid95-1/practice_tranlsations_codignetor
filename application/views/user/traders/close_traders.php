					...
					<div class="card">
						<div class="card-body">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
								...
								<?php if (isset($dataItem['closeTrade']) && $dataItem['closeTrade']){
									foreach ($dataItem['closeTrade'] as $key=>$item):
									?>
									<tr>
										<td><?=++$key?></td>
										...
										<td>$<?=number_format($item->open_price , 2)?></td>
										<td><?=$item->trade_open_datetime?></td>
										<td>$<?=number_format($item->close_price , 2)?></td>
